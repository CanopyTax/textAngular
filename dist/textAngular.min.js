...
// like Node.
module.exports=b(require("rangy"),require("rangy/lib/rangy-selectionsaverestore")):a.textAngular=b(a.rangy)}(this,function(a){
...
if(g.ie>8||void 0===g.ie){var r=document.styleSheets;/* istanbul ignore next: preference for stylesheet loaded externally */
try{for(var s=0;s<r.length;s++)if((0===r[s].media.length||r[s].media.mediaText.match(/(all|screen)/gi))&&r[s].href&&r[s].href.match(/textangular\.(min\.|)css/gi)){l=r[s];break}}catch(a){}/* istanbul ignore next: preference for stylesheet loaded externally */
l||(
